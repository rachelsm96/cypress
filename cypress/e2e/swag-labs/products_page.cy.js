...
context("filter section", () => {
  ...
  it("all filter options are shown", () => {
    cy.get("option")
      ...
      .then(($els) => {
        return Cypress.$.makeArray($els).map((e1) => e1.innerText);
      })
      .should("deep.equal", [
        "Name (A to Z)",
        "Name (Z to A)",
  ...
  it("Sort from high to low", function () {
    ...
    cy.get(".inventory_item_name")
      ...
      .should("deep.equal", [
        this.product["jacket"].name,
        this.product["backpack"].name,
        this.product["boltShirt"].name,
        this.product["redShirt"].name,
        this.product["bikeLight"].name,
        this.product["onesie"].name,
      ]);
    ...
    cy.get(".inventory_item_price")
      ...
      .should("deep.equal", [
        this.product["jacket"].price,
        this.product["backpack"].price,
        this.product["boltShirt"].price,
        this.product["redShirt"].price,
        this.product["bikeLight"].price,
        this.product["onesie"].price,
      ]);
  });
